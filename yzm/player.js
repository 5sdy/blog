!function(e, t) {
          ...
          , Y = function() {
            ...
            return o(e, [{
                ...
                value: function(e) {
                    ...
                    this.video.currentTime < e ? this.notice(this.tran("快进") + " " + (e - this.video.currentTime).toFixed(0) + " " + this.tran("s")) : this.video.currentTime > e && this.notice(this.tran("快退") + " " + (this.video.currentTime - e).toFixed(0) + " " + this.tran("s")),
                ...
                value: function(e) {
                    ...
                    if (this.qualityIndex !== e && !this.switchingQuality) {
                        ...
                        this.notice(this.tran("正在切换至") + " " + this.quality.name + " " + this.tran("画质"), -1),
                        ...
                        this.on("canplay", function() {
                            if (t.prevVideo) {
                                ...
                                n || t.video.play(),
                                t.prevVideo = null,
                                t.notice(t.tran("正在切换至") + " " + t.quality.name + " " + t.tran("画质")),
                ...
                value: function() {
                    ...
                    document.querySelector(".yzmplayer-full-in-icon").onclick = function() {
                        if (!document.pictureInPictureElement) {
                            document.querySelector("#video").requestPictureInPicture().catch(error=>{// 视频无法进入画中画模式
                            }
                            );
                        } else {
                            document.exitPictureInPicture().catch(error=>{// 视频无法退出画中画模式
                            }
                            );
                        }
                    }
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            t += s(r("Send")),
            t += '" data-balloon-pos="up" style="background: ',
            t += s(o.theme),
